...
At this point, you'll need to fill in those files with some data: Ground truth 
in the one for the panel and the results from the assay under consideration in 
the one for the evaluation. 
...
quantitative) using `score_evaluation()`. 
